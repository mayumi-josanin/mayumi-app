    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          required: false,
          options: [],
          visibleWhen: { questionId: "q_bijiris_session_concern", value: "その他（長文）" },
        },
        {
          id: "q_measure_m_life_changes",
          label: "日常生活にどのような変化がありましたか？（複数選択可）",
          type: "checkbox",
          required: false,
          options: BIJIRIS_SESSION_LIFE_CHANGE_OPTIONS,
        ...
        },
        {
          ...
          required: false,
          options: [],
          visibleWhen: { questionId: "q_measure_m_life_changes", value: "その他（自由記述）" },
        },
        {
